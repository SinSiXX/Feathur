...
class CPHPPromiseBase
{
	public function __construct($creator, $head)
	{
	...
	public function Resolve($data)
	{
		...
		while(true)
		{
			if(is_null($first->previous) || $first->previous == $this->head)
			{
				break;
			}
			else
...
class CPHPPromise extends CPHPPromiseBase
{
	
}

class CPHPPromiseContainer extends CPHPPromiseBase
{
	public function __construct($creator, $head, $children)
	{
		parent::_construct($creator, $head);
		$this->children = $children;
	}
}

class CPHPPromiseHead extends CPHPPromiseBase
{
